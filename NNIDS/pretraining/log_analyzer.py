"""
***DEPRECATED***
This file is supposed to analyze contents of a .log file
It was used for the MDP project but has not been integrated into this project
"""
# import os
...
#             [temp_fig, out_string] = plotters.plot_bit_occurrences('Number of 1\'s in bit position '
#                                                                   'i,'
...
#
#         [temp_fig, out_string] = plotters.plot_bit_occurrences('Number of 1\'s in bit position i,'
#                                                               '\n' + 'All', all_msg_data)
#         figures.append(temp_fig)
#         out_file.write(out_string)
#
...
#
#         id_occurrence_figures.append(plotters.plot_id_occurrences('CAN ID Occurrences,'
#                                                                  '\n' + file, id_freq_map))
#     id_occurrence_figures.append(plotters.plot_id_occurrences('CAN ID Occurrences,'
...
#         [fig, avg_freq] = plotters.plot_id_frequency_distribution('Frequency Distribution of ID 0x'
#                                                                  + identifier,
#                                                                  all_data[identifier])
#         figures.append(fig)
...
#     fig = plotters.plot_id_avg_frequency('Average Frequency of Each CAN ID', all_data)
#     pp.savefig(fig)
#     pp.close()
#
#
...
#     pp.savefig(plotters.plot_entropies('Entropy of CAN Bus vs Time', timestamps, entropies))
#     pp.close()
#
#
...
#     can_msgs = {}
#     for file in files:
#         can_msgs[file[file.find('recording'):]] = log.log_parser(file)
#
