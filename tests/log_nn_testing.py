"""
Script for testing the neutral network on .log files, note that is it trained on .log data and
uses the TensorFlow model in ml_ids_model.
This should should not be used.
"""
...
def test_model(classifier, print_test):
    ...
    print()
    print('Replay message statistics: ' + str(num_valid_caught) + ' caught / ' + str(num_valid)
    ...
    print('All zero: ' + str(num_dos_caught) + ' caught / ' + str(num_dos)
