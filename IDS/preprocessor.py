...
class DataPreprocessor:
    ...
    inject_malicious_packets -- Take in a list of CAN messages and a malicious generator and inject malicious packets into the list.
    ...
    based IDS.
    write_feature_lists -- Take in a list of features and the path to a file to write, and write a file containing the feature list to disk. load_feature_lists -- Take the path to a feature list file and return the feature lists from the file.
    """
    ...
    def inject_malicious_packets(self, canlist, malgen):
        ...
        messages, and labels is a NumPy array of the labels for each message.
        """
        newcanlist = []
        ...
        labels.append(0)
        return newcanlist, np.array(labels)
    ...
    def generate_feature_lists(self, canlist, idprobs):
        ...
        'system_entropy_change': [...]}, where each key is a NumPy array.
        """
        featurelist = {
            'id': [],
        ...
        for key in featurelist.keys():
            featurelist[key] = np.array(featurelist[key])
        return featurelist
