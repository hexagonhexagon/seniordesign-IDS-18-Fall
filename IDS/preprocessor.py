...
class DataPreprocessor:
    ...
    def inject_malicious_packets(self, canlist, malgen):
        pass
        # newcanlist = []
        # labels = [] # The labels for the frames. 0 means the
        # packet is not malicious, and 1 means the packet is malicious. This is
        # used later in the DNN based IDS.
        # for frame in canlist:
        #   newcanlist.append(frame)
        #   labels.append(0)
        #   malicious_frame = malgen.get()
